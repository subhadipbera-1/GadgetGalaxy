    ...
    <div class="row">
        ...
        <div class="col-lg-6 order-3">
            <div class="product_description">
                ...
                <div class="product_name"><?php echo $data['description']; ?></div>
                ...
                <div>
                    ...
                    <span class="product_info">Warranty: 1 Year warranty<span><br>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6">
                        ...
                        <!-- <div class="form-group">
                            ...
                            <div class="input-group" style="width: 130px;">
                                <div class="input-group-prepend">
                                    <button class="btn btn-outline-secondary" type="button" id="decreaseQuantity" style="font-size:medium;">-</button>
                                </div>
                                <input type="number" id="quantity" name="quantity" class="form-control text-center" value="1" min="1" style="font-size:medium;">
                                <div class="input-group-append">
                                    <button class="btn btn-outline-secondary" type="button" id="increaseQuantity" style="font-size:medium;">+</button>
                                </div>
                            </div>
                        </div> -->
                        <!-- Quantity Input with Increment and Decrement End --> 
                        ...
                        <a href="wishlist_action.php?u_id=<?php echo  $data['p_id']; ?> &pid=<?php echo $data['p_id']; ?>"><button type="button" class="btn btn-warning shop-button" style="color: #fff;">Wishlist</button></a>

                        <!-- <a href="checkout.php?total_amount=<?php echo $data['p_id']; ?>"><button type="button" class="btn btn-success shop-button">Buy Now</button></a> -->
                        <a href="checkout.php?id=<?php echo $data['p_id']; ?>&total_amount=<?php echo $data['price']; ?>"><button type="button" class="btn btn-success shop-button">Buy Now</button></a>
        ...
        <table class="col-md-12">
            <tbody>
                <tr class="row mt-10">
                    ...
                    <td class="col-md-8">
                        <ul>
                            <li><?php echo $data['sales_package']; ?></li><!--2 in 1 Laptop, Power Adaptor, Active Stylus Pen, User Guide, Warranty Documents-->
                        </ul>
                    </td>
                </tr>
                <tr class="row mt-10">
                    ...
                    <td class="col-md-8">
                        <ul>
                            <li><?php echo $data['model_number']; ?></li><!--14-dh0107TU-->
                        </ul>
                    </td>
                </tr>
                <!-- <tr class="row mt-10">
...
<script>
    ...
    // Ensure input value stays within valid range when manually entered
    quantityInput.addEventListener('input', () => {
        if (quantityInput.value === '' || parseInt(quantityInput.value) < parseInt(quantityInput.min)) {
